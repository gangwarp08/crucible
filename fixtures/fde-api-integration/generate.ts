// Deterministic synthetic dataset generator for the fde-api-integration
// scenario (family 2, P3.1 — seeded DORMANT by migration 0023).
//
...
//                         root_cause }
//
// Run: pnpm exec tsx fixtures/fde-api-integration/generate.ts
//
...
const SEED_LABEL = "fde-api-integration-v1";
const COMPANY = "Solstice Retail";
const PROVIDER = "ContactHub";
const TARGET_CONTACTS = 5200;   // provider-side contact count (± jitter)
const PAGE_SIZE = 40;           // provider page size for /v2/contacts
const SKIP_INCIDENT_COUNT = 6;  // stale-cursor retries → pages silently skipped
const AUTH_401_COUNT = 5;       // expired-token 401s (red herring — all retried OK)
