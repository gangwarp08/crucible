// Deterministic synthetic dataset generator for the fde-db-triage scenario.
//
...
const SEED_LABEL = "fde-db-triage-v1";
...
const SCHEMA_SQL = `-- fde-db-triage synthetic schema (GENERATED — do not edit by hand)
...
function serializeSeed(
  ...
  const parts: string[] = [];
  parts.push("-- fde-db-triage synthetic seed (GENERATED — do not edit by hand)");
  parts.push("-- Regenerate via: pnpm exec tsx fixtures/fde-db-triage/generate.ts");
  parts.push("BEGIN;");
  parts.push("");
...
function main(): void {
  ...
  console.log("[fde-db-triage] generator complete");
