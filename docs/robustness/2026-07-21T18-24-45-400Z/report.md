# Robustness & Validity Report — 2026-07-21T18-24-45-400Z

Classes: genuine · Scenarios: fde-db-triage · SPEED=0.25
Runs: 1 attempted, 1 scored · Simulator spend: $0.2160 over 37 calls
...
- Session duration (min): min 4.44, median 4.44, max 4.44
- Runs under 10 active min (would fail scorability floor): 1 (100%)
- Mean simulated active time: 13.43 min (pacing-driven, not a burst).

## 3. Ranked improvement backlog

1. **[MED]** genuine-strong scores outside expected band — mean 1.89 vs band 4.2–5. Either the persona prompt or the calibration band needs adjustment.
...
3. **[LOW]** 1 runs had ≥3 simulator JSON parse failures — Harness robustness: tighten the action-format instruction or add a repair step.
