...
const CORE: Verifier[] = [
  ...
  { name: "family2-content", file: "verify-family2-content.ts", note: "P3.1 authored content + fork beat + dormant seed (local always; DB part skips pre-0023)" },
  { name: "family2-units", file: "verify-family2-units.ts", note: "P3.2 fde-api-integration detectors + fork dissociability (deterministic)" },
  { name: "family1-drift-inert", file: "verify-family1-drift-inert.ts", note: "P3.2 v3 detectors inert on family 1 (deterministic byte-diff)" },
  { name: "isomorph-fork-equivalence", file: "verify-isomorph-fork-equivalence.ts", note: "7.4 iso fork parity (2 LLM playthroughs; skips if unseeded)" },
  { name: "fork-discrimination", file: "verify-fork-discrimination.ts", note: "7.5 design separation increases (2 LLM playthroughs; skips if unseeded)" },
  { name: "cross-family-scale", file: "verify-cross-family-scale.ts", note: "P3.5 shared-model/scale structure (Supabase-only; skips if family 2 unseeded)" },
  { name: "family2-dormant", file: "verify-family2-dormant.ts", note: "P3.5 dormancy: catalog-hidden, admin calibration path open (skips pre-0023)" },
  { name: "family2-discrimination", file: "verify-family2-discrimination.ts", note: "P3.4 dormant-family strong/weak + native fork (2 LLM playthroughs; skips if unseeded)" },
  { name: "family2-isomorph", file: "verify-family2-isomorph.ts", note: "P3.4 dormant-family isomorph equivalence (2 LLM playthroughs; skips if unseeded)" },
  ...
  { name: "deadline-reaper", file: "verify-deadline-reaper.ts", note: "force-completes overdue sessions (stuck-defending fix)" },
